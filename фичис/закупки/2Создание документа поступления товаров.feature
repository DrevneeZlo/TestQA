...
Функционал: создание документа Постепления товаров

Как Менеджер по закупкам я хочу
создание документа постепления товара
...
* Проверка заполнения табличной части	
	Тогда таблица 'Товары' содержит строки:
		...
		| 'Масло' | 'ПРД-0002' | '30,00' | '5,00'       | '150,00' |
...
Сценарий: проверка наличия в справочнике номенклатуры Масло
